...
struct AlboLeslieURLS {
    // API URLS
    static let restURL = "https://ourairport-data-search.p.rapidapi.com/"
    // API Key
    static let apiKey = "aa8b436a8dmsh335ca160cc4f4d7p1c8444jsn99acc8d0bfd6"
    static let apiHost = "ourairport-data-search.p.rapidapi.com"
